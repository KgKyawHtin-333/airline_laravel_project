...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2020 at 03:39 PM
...
(8, '2020_11_13_104446_create_seats_table', 1),
...
(13, '2020_11_16_054032_create_bookings_table', 1),
(14, '2020_11_16_054209_create_booking_seats_table', 1);
...
(1, '120000 MMK', 1, 4, '2020-11-15 23:21:43', '2020-11-15 23:21:43'),
(2, '80000 MMK', 1, 2, '2020-11-15 23:22:18', '2020-11-15 23:22:18'),
(3, '95000 MMK', 1, 3, '2020-11-15 23:22:41', '2020-11-15 23:22:41'),
(4, '57000  MMK', 2, 3, '2020-11-15 23:23:02', '2020-11-15 23:23:02');
...
ALTER TABLE `bookings`
  ...
  ADD KEY `bookings_airline_id_foreign` (`airline_id`),
...
ALTER TABLE `seats`
  ...
  ADD KEY `seats_airline_id_foreign` (`airline_id`),
...
--
ALTER TABLE `bookings`
  ADD CONSTRAINT `bookings_airline_id_foreign` FOREIGN KEY (`airline_id`) REFERENCES `airlines` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `seats`
  ADD CONSTRAINT `seats_airline_id_foreign` FOREIGN KEY (`airline_id`) REFERENCES `airlines` (`id`) ON DELETE CASCADE,
