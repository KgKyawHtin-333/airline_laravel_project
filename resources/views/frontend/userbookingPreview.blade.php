   ...
   <div class="row my-5">
         ...
         <form id="bookingForm" action="" method="">
            ...
            <div class="card my-5">
               ...
               <div class="card-body">
                  ...
                  <div class="form-group">
                     <!--Bootstrap mr date form atwt ready shi tl -->
      ...
      <div class="col-md-4 my-5">
         ...
         <div class="card">
          ...
          <div class="card d-none"  id="roundTripDetail" >
            <div class="card-header" style="background-color: skyblue">
               <h2 >Return Way Booking Details </h2>
            </div>
            <div class="card-body">
               <div>
                  <h5>From-To</h5>
                  <span id="rfromCity"></span>-<span id="rtoCity"></span>
                  <hr>
                  <h5>Time</h5>
                  <p id="rtime"> </p>
                  <hr>
                  <h5> Departure Date - <span id="rdate"></span></h5>
                  <hr>
                  <h5 id="rairlinename">  </h5>
                  <hr>
                  <h5>Seat - <span id="rclassname"></span></h5>
                  <hr>
                  <h5>Adult - <span id="radult"></span></h5>
                  <h5>Child - <span id="rchild"></span></h5>
               </div>
                
            </div>
            <div class="card-footer" style="background-color: skyblue">
               <div>
                  <h5 > Total price - <span id="rtotalprice"></span></h5>
               </div>
            </div>
         </div>
