  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="{{route('flight.index')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label"> Flights </span></a></li>

        <li><a class="app-menu__item" href="{{route('booking.index')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label"> Bookings </span></a></li>
        ...
        <li><a class="app-menu__item" href="{{route('time.index')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label"> Time </span></a></li>

        <li><a class="app-menu__item" href="{{route('class_flight.index')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label"> Class </span></a></li>

        <li><a class="app-menu__item" href="{{route('seat.index')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label"> Seats </span></a></li>
